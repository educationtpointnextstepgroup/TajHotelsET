! function(e) {
        ...
        var u = ["longtask", "resource"],
            a = function() {
                function e(t) {
                    ...
                    }(this, e), this.measures = [], this.subscription = new Map;
                    if (!("PerformanceObserver" in window) || !("performance" in window) || ! function() {
                    ...
                    this.observer = new PerformanceObserver((function(e) {
                        e.getEntries().forEach((function(e) {
                            var o, i, u = [];
                            if ("longtask" === e.entryType) o = "longtask", u.push({
                                name: o,
                                ...
                                var a = null == t ? void 0 : t.some((function(t) {
                                    return e.name.includes(t)
                                }));
                                "script" === e.initiatorType && a ? (o = "resource_timing", u.push({
                                    name: o,
                                ...
                                })) : "xmlhttprequest" === e.initiatorType && a && (o = !e.responseStatus || e.responseStatus >= 200 && e.responseStatus < 400 ? "request_latency" : "request_error", u.push({
                                    name: o,
                                    startTime: e.fetchStart,
                                    duration: e.responseEnd - e.fetchStart,
                                    detail: {
                            ...
                            u.length && (r.measures = [].concat(u, n(r.measures)), o && r.subscription.has(o) && (null === (i = r.subscription.get(o)) || void 0 === i || i(u, e)))
                        }))
                    }))
                }
                var t, r, o;
    ...
    212: function(e, t, r) {
        "use strict";
        r.r(t), r.d(t, "browserPerf", (function() {
            return c
        ...
        var n, o = r(126),
            ...
            c = {
                ...
                subscribe: function() {
                    n.subscribe("resource_timing", u), n.subscribe("request_latency", a), n.subscribe("request_error", s)
                }
            },
            f = function() {
                c.init();
